...
class Game(arcade.Window):
    def __init__(self):
        ...
        self.new_enemies = None
        self.background = arcade.load_texture('../24/14_Interstellar/NightSky.jpg')
        self.score = 0
        ...
        self.my_thread = threading.Thread(arcade.schedule(self.add_enemy, 3))
    ...
    def game_over(self):
        ...
        self.background = arcade.load_texture('../24/14_Interstellar/GameOver.jpg')
        print('GAME OVER 💀')
    ...
    def on_draw(self):
        ...
        arcade.draw_text(f'SCORE:{self.score}', 1155, 22, arcade.color.ALABAMA_CRIMSON, 15, 2, 'left',
                         ('calibri', 'arial'), True)
